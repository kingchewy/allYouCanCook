...
var ResetPasswordPage = /** @class */ (function () {
    ...
    ResetPasswordPage.prototype.resetPassword = function (resetPasswordForm) {
        var _this = this;
        if (!resetPasswordForm.valid) {
            ...
            this.authService.resetPassword(email).then(function () { return __awaiter(_this, void 0, void 0, function () {
                var alert;
                var _this = this;
