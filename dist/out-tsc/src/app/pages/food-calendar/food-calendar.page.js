...
var FoodCalendarPage = /** @class */ (function () {
    function FoodCalendarPage(alertCtrl, dateTimeService) {
    ...
    FoodCalendarPage.prototype.alertAddFoodOnEmpty = function () {
        var _this = this;
        this.dataService.loadMyFoods().then(function (result) {
            var foodsArray = _this.dataService.getFoodsList();
    ...
    FoodCalendarPage = __decorate([
        ...
        __metadata("design:paramtypes", [angular_1.AlertController, date_time_service_1.DateTimeService])
    ], FoodCalendarPage);
